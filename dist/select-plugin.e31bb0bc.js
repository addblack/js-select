...
var getTemplate = function getTemplate(placeholder, data, selectedId) {
  ...
  var items = data.map(function (item) {
    ...
    return "<li class=\"".concat(classes, "\" id=\"").concat(item.id, "\" data-type=\"item\" data-id=\"").concat(item.id, "\">").concat(item.value, "</li>");
  });
  return "\n    <div class=\"select__back\" data-type=\"backdrop\"></div>\n      <div class=\"select__input\" data-type=\"input\">\n        <span data-type=\"value\">".concat(text, "</span>\n        <i class=\"fas fa-chevron-down\" data-type=\"arrow\"></i>\n      </div>\n            <div class=\"select__dropdown\">\n           <ul class=\"select__list\">\n                ").concat(items.join(''), "\n            </ul>\n      </div>\n    ");
};
  ...
  _createClass(Select, [{
    ...
    get: function get() {
      ...
      return this.options.data.find(function (item) {
        return item.id === Number(_this.selectedId);
      });
    }
  }]);
...
var _render2 = function _render2() {
  var _this$options = this.options,
      ...
      data = _this$options.data; // console.log(placeholder, data);
...
},{"./bundle-url":"C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/styles.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
window.s = select;
},{"./select/select":"select/select.js","./select/styles.scss":"select/styles.scss"}],"C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
